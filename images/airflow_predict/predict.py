...
@click.option("--preprocessor_path", default="../data/preprocess_pipeline/preprocessor.pkl")
@click.option("--model_path", default="../data/models/model.pkl")
@click.option("--dir_in", default="../data/predictions")
def predict(dir_from: str, dir_in: str, model_path: str, preprocessor_path: str) -> None:
